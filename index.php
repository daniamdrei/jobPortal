...
<?php 
  ...
  $select = $conn->query(" SELECT * FROM jobs ORDER BY created_at DESC LIMIT 5 ");
  $select->execute();
  $jobs = $select->fetchAll(PDO::FETCH_OBJ);
   //select for trending word
  $searches=$conn->query('SELECT COUNT(keyword) AS count , keyword FROM searches 
  GROUP BY keyword ORDER BY COUNT DESC  LIMIT 3 ');
  $searches -> execute();
  $search = $searches->fetchAll(PDO::FETCH_OBJ);
            ...
            <form method="post"  action="search.php" class="search-jobs-form">
              <div class="row mb-5">
                <div class="col-12 col-sm-6 col-md-6 col-lg-3 mb-4 mb-lg-0">
                  <input type="text" name="job_title" class="form-control form-control-lg" placeholder="Job title, Company...">
                </div>
                <div class="col-12 col-sm-6 col-md-6 col-lg-3 mb-4 mb-lg-0">
