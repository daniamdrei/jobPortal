...
<?php 
    ...
    $get_categories = $conn->query("SELECT * FROM categorie");
    ...
    if(isset($_GET['id'])) {
        ...
        if(isset($_SESSION['user_id']) AND $singleJob->company_id !== $_SESSION['user_id']) {
            header("location: index.php");
        }
    ...
    if(isset($_POST['submit'])) {
        ...
        header('location:jop_update.php?errpr=some input are empty');
        } else {
        ...
        $update = $conn->prepare("UPDATE jobs SET job_title = :job_title, job_region = :job_region, job_type = :job_type, vacancy = :vacancy,
            Job_Categorie = :Job_Categorie, experience = :experience, salary = :salary, gender = :gender, application_deadline = :application_deadline,
            ...
            header("location:job_update.php?id=".$id."");
...
?>
    ...
    <section class="site-section">
        ...
        <div class="row mb-5">
            <div class="col-lg-12">
            <form class="p-4 p-md-5 border rounded" action="job_update.php?id=<?php echo $id; ?>" method="post">
